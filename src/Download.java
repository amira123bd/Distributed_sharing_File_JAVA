...
public class Download extends Thread
{
    ...
    */
    ...
    Download(int peerServerPort,String directoryPath) {        
    ...
    public void run(){
    	try {
    			...
    			new DownloadThread(dwldSocket,directoryPath).start();
        } 
...
class DownloadThread extends Thread
{
    ...
    public DownloadThread(Socket dwldThreadSocket,String directoryPath)
    {
	...
	public void run()
    {
        try
        {
            ...
            while(true)
            {
               ...
               System.out.println("envoi du fichier avec " +byte_arr.length+ " bytes");
